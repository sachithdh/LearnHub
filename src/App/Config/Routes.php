...
function registerRoutes(App $app)
{
    ...
    $app->get('/courses/my/registered', [CoursesController::class, 'regCourses']);
    $app->get('/courses/user', [CoursesController::class, 'userCourses']);
    ...
    $app->put('/course/request/{requestId}/comments/{commentId}', [PostController::class, 'updateComment']);
    ...
    $app->delete('/course/request/{requestId}/comments/{commentId}', [PostController::class, 'deleteComment']);
